...
#GCC_PATH=/ece/ericro/common/gcc920_64
#GCC_SUFFIX=920
...
CFLAGS="-D__riscv64 -march=rv64imfd -mabi=lp64d"  ASFLAGS="-march=rv64imfd -mabi=lp64d" build_project riscv-pk --prefix=$RISCV_INSTALL/riscv64-unknown-elf --host=riscv64-unknown-elf --disable-atomics
